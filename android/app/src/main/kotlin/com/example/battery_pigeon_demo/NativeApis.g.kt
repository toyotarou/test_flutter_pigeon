...
interface BatteryApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: BatteryApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.battery_pigeon_demo.BatteryApi.getBatteryLevel$separatedMessageChannelSuffix", codec)
        if (api != null) {
